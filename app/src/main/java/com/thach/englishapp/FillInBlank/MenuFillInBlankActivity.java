package com.thach.englishapp.FillInBlank;
...
public class MenuFillInBlankActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                MenuFillInBlankActivity.super.onBackPressed();
            }
        });
    }
    ...
    private void onCLickGoToFillInBlank(Topic topic){
        Intent intent = new Intent(this, FillInBlankActivity.class);
